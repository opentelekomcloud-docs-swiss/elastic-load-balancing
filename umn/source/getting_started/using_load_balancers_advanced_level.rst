...
-  You have added security group rules to allow traffic from the ports used by the two ECSs. (Alternatively, you can enable all ports first and then disable the ports that are no longer used.) For details, see :ref:`Configuring Security Group Rules for Backend Servers <elb_ug_hd_0007>`.
...
#. Install and start Nginx.
   ...
   e. Enter **http://**\ *EIP bound to the ECS* in the address box of your browser. If the following page is displayed, Nginx has been installed.
      ...
      .. figure:: /_static/images/en-us_image_0000001445375386.png
...
#. Use your browser to access **http://**\ *ECS01 EIP*\ **/ELB01/** and **http://**\ *ECS02 EIP*\ **/ELB02/** to verify that Nginx has been deployed.
   ...
   -  HTML page of ECS01
      ...
      .. figure:: /_static/images/en-us_image_0000001495695305.png
   ...
   -  HTML page of ECS02
      ...
      .. figure:: /_static/images/en-us_image_0000001445855218.png
...
.. figure:: /_static/images/en-us_image_0000001445695254.png
...
#. Modify the **C:\\Windows\\System32\\drivers\\etc\\hosts** file on your PC to map the domain name to the load balancer EIP.
   ...
   .. figure:: /_static/images/en-us_image_0000001445855206.png
...
#. Use your browser to access **http://www.example.com/ELB01/**. If the following page is displayed, the load balancer has routed the request to ECS01.
   ...
   .. figure:: /_static/images/en-us_image_0000001495495229.png
...
#. Use your browser to access **http://www.example.com/ELB02/**. If the following page is displayed, the load balancer has routed the request to ECS02.
   ...
   .. figure:: /_static/images/en-us_image_0000001445855230.png
      :alt: **Figure 7** Accessing ECS02

      **Figure 7** Accessing ECS02

.. |image1| image:: /_static/images/en-us_image_0000001445375306.png
.. |image2| image:: /_static/images/en-us_image_0000001495495213.png
.. |image3| image:: /_static/images/en-us_image_0000001445375306.png
