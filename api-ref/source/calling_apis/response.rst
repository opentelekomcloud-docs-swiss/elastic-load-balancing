:original_name: elb_dy_0004.html
...
A status code is a group of digits, ranging from 1xx to 5xx. It indicates the status of a request. For more information, see :ref:`Status Codes <elb_gc_1102>`.
