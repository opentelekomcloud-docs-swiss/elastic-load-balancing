:original_name: elb_fl_0008.html
...
-  :ref:`Obtain the Project ID by Calling an API <elb_fl_0008__en-us_topic_0121673684_section86806471133>`
-  :ref:`Obtain the Project ID from the Console <elb_fl_0008__en-us_topic_0121673684_section11508201712212>`

.. _elb_fl_0008__en-us_topic_0121673684_section86806471133:
...
The API used to obtain a project ID is GET https://{Endpoint}/v3/projects. {Endpoint} is the IAM endpoint and can be obtained from the administrator. For details about API authentication, see :ref:`Authentication <elb_dy_0003>`.
...
.. _elb_fl_0008__en-us_topic_0121673684_section11508201712212:
